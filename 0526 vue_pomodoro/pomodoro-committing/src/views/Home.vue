<template>
  <div id="home">
    ...
    <div id="clock" class="d-flex w-100 p-0 m-auto container flex-wrap">
      ...
      <radial-progress-bar v-if="!isBreak" class="m-auto col-12 col-lg-6 p-0" :diameter="350" :completed-steps="timeleft" :total-steps="totaltime" startColor="#eee"   stopColor="#e74" innerStrokeColor="#444">
      ...
      <radial-progress-bar v-else class="m-auto" :diameter="350" :completed-steps="timeleft" :total-steps="totaltimebreak" startColor="#ccc"   stopColor="#c11" innerStrokeColor="#333">
          <b-btn variant='primary' v-if='status!=1'     @click='start' >
          <font-awesome-icon :icon="['fas','play']" ></font-awesome-icon>
          </b-btn>
          <b-btn  variant='danger' v-if='status==1'     @click='pause'>
